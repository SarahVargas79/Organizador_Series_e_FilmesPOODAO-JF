...
public class jfSerie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtSeries.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Título", "Ano de Lançamento", "Atores", "Nacionalidade", "Gênero", "Temporada", "Episódio", "Usuário"
            }
        ) {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jtfTemporada, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel9)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jtfEpisodio))
    ...
    private void jbAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAlterarActionPerformed
        ...
        String titulo = (String) jtSeries.getValueAt(linha, 0);
        SerieServicos livroS = ServicosFactory.getSerieServicos();
        Serie s = livroS.buscaSerieTitulo(titulo);
    ...
    private void jbExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirActionPerformed
        ...
        String titulo;
        linha = jtSeries.getSelectedRow();
        titulo = (String) jtSeries.getValueAt(linha, 0);
        SerieServicos serieS = ServicosFactory.getSerieServicos();
        Object[] resp = {"Sim", "Não"};
    ...
    private void jbSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSalvarActionPerformed
        if (validaInputs()) {
            ...
            Serie s = new Serie(idSerie, titulo, anoLancamento, nomeAtor, nacionalidade, genero, temporada, episodio, usu);
